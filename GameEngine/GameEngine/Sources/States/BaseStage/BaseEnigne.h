#ifndef _STATE_BASE_HEADER_
#define _STATE_BASE_HEADER_

#include "../../Base/Graphic/Sprite.h"
#include "../../Base/Graphic/Scene.h"
#include "../../Base/Physics/World.h"
