...
enum UniformType{ 
	TYPE, TIME,
	TEXTURE, UV, COLOR,
	MODEL, VIEWPORT, PROJECTION,
	INVERSE_TOGGLE,
	BLUR_TOGGLE, BLUR_AMOUNT,
	SOBEL_TOGGLE, SOBEL_AMOUNT,
	WAVE_TOGGLE, WAVE_TYPE, WAVE_PHASE,
	LIGHT_RADIUS, LIGHT_DIFFUSE, LIGHT_DISTANCE,
	PARTICLE_SPD, PARTICLE_POS, PARTICLE_VEL, PARTICLE_LIFE, PARTICLE_FADE, PARTICLE_ROT, 
	EMITTER_TYPE, EMITTER_EXPLO, EMITTER_BOUND, EMITTER_COLOR, EMITTER_EDGE, EMITTER_DIR, EMITTER_SPD, EMITTER_RNDSCL,
	UNIFORM_END
};
