...
enum UniformType{ 
	...
	PARTICLE_DIR, PARTICLE_SPD, PARTICLE_POS, PARTICLE_FORCE, PARTICLE_FADE, PARTICLE_BOUND, PARTICLE_LIFE, PARTICLE_ROT, PARTICLE_COLOR, PARTICLE_EDGE, PARTICLE_QNT,
